...
export const PORTFOLIO_DATA: ProfileData = {
  ...
  skills: [
    ...
    { name: "ROS 2", level: 90, category: "Frameworks/Libraries" },
    { name: "OpenCV", level: 85, category: "Frameworks/Libraries" },
    { name: "YOLOv11", level: 85, category: "Frameworks/Libraries" },
    { name: "TensorRT", level: 80, category: "Frameworks/Libraries" },
    { name: "NumPy", level: 90, category: "Frameworks/Libraries" },
    { name: "Pandas", level: 85, category: "Frameworks/Libraries" },
    ...
    { name: "Git", level: 85, category: "Software/Tools" },
    { name: "Docker", level: 80, category: "Software/Tools" },
    { name: "Gazebo", level: 80, category: "Software/Tools" },
    { name: "SLAM Toolbox", level: 80, category: "Software/Tools" },
    { name: "Windows", level: 90, category: "Operating Systems" },
    { name: "Linux (Ubuntu)", level: 90, category: "Operating Systems" }
  ],
  leadership: [
    {
      id: "lead-1",
